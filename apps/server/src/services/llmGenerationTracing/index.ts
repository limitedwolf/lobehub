 ...
 *
 * Always invoked through the post-response scheduler so it never blocks the
 * user response. Both store and DB failures are swallowed and logged — the DB
 * row is the source of truth for analytics, the blob is a cold artefact for
 * offline review.
 */
