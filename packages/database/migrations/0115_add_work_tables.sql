...
ALTER TABLE "work_contexts" DROP CONSTRAINT IF EXISTS "work_contexts_message_id_messages_id_fk";--> statement-breakpoint
ALTER TABLE "work_contexts" ADD CONSTRAINT "work_contexts_message_id_messages_id_fk" FOREIGN KEY ("message_id") REFERENCES "public"."messages"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "work_contexts" DROP CONSTRAINT IF EXISTS "work_contexts_agent_id_agents_id_fk";--> statement-breakpoint
ALTER TABLE "work_contexts" ADD CONSTRAINT "work_contexts_agent_id_agents_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."agents"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "work_contexts_work_id_tool_call_id_unique" ON "work_contexts" USING btree ("work_id","tool_call_id") WHERE "work_contexts"."tool_call_id" is not null;--> statement-breakpoint
