...
CREATE UNIQUE INDEX "user_connectors_agent_identifier_unique" ON "user_connectors" USING btree ("agent_id","identifier") WHERE "user_connectors"."agent_id" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "user_connectors_agent_id_idx" ON "user_connectors" USING btree ("agent_id");--> statement-breakpoint
CREATE UNIQUE INDEX "user_connectors_user_identifier_unique" ON "user_connectors" USING btree ("user_id","identifier") WHERE "user_connectors"."agent_id" IS NULL;