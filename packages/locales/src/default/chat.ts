export default {
  ...
  'workingPanel.works.empty': 'No works yet. Tasks created in this conversation will show up here.',
  'workingPanel.works.error': 'Failed to load works',
  'workingPanel.works.loading': 'Loading works...',
  'workingPanel.works.version.collapse': 'Hide versions',
  'workingPanel.works.version.empty': 'No versions yet',
  'workingPanel.works.version.error': 'Failed to load versions',
  'workingPanel.works.version.expand': 'Show versions',
  'workingPanel.works.version.loading': 'Loading versions...',
  'workingPanel.works.version.source.createTask': 'Created',
  'workingPanel.works.version.source.createTasks': 'Created',
  'workingPanel.works.version.source.editTask': 'Edited',
  'workingPanel.works.version.source.setTaskSchedule': 'Schedule updated',
  'workingPanel.works.version.source.updateTaskStatus': 'Status updated',
