export default {
  ...
  'backgroundProcesses.findOrphans': 'Find orphans',
  'backgroundProcesses.forceStop': 'Force end process',
  'backgroundProcesses.notification.desc':
    '{{count}} leftover background processes from a previous session',
  'backgroundProcesses.notification.dismiss': 'Dismiss',
  'backgroundProcesses.notification.done': 'Leftover processes ended',
  'backgroundProcesses.notification.endAll': 'End all',
  'backgroundProcesses.orphans.empty': 'No leftover processes found',
  'backgroundProcesses.orphans.title': 'Detected leftovers',
  'backgroundProcesses.sessions.close': 'Close session',
