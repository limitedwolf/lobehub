...
describe('RuntimeExecutors', () => {
 ...
 it('should re-throw when messageModel.create fails', async => {
 ...
 // Before we fell back to the original parentMessageId here      // which was itself the deleted parent that caused the failure — so the
 ...
 // The behavior logged the error and kept walking the
